...
if interactive_input:
    ...
    if default_vals in ['y', 'Y', 'yes', 'YES', 'Yes']:
        learn_len = 100
        max_lags = 10
        max_linear = 72
        max_linar = 14
    ...
    filepath = ''  # INSERT YOUR FILE NAME.
    column_dates = ''  # INSERT THE HEADER OF THE DATES COLUMN.
    column_id = ''  # INSERT THE HEADER OF THE COLUMN WITH OBSERVATIONS TO BE INTERPOLATED.
    ...
    output_file = ''  # INSERT YOUR OUTPUT FILE NAME
